...
public class ConfirmIndexSalesOrder : IHandle<SalesOrderConfirmed>
{
    private readonly SearchClient _client;
    private readonly IInvokeProjections<SalesOrder> _projection;
    private readonly ILogger<IndexSalesOrder> _logger;

    public ConfirmIndexSalesOrder(IInvokeProjections<SalesOrder> projection, SearchClient client, ILogger<IndexSalesOrder> logger = null!)
    {
        _client = client;
